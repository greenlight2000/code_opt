...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_test_data_codellama.jsonl', type=str)
    parser.add_argument('--log_file_name', default='code_test_data_codellama.log', type=str)
...
if __name__ == '__main__':
    ...
    max_new_tokens = 6144  # max_output_tokens
