...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_generation_eval_vicuna.jsonl')
    parser.add_argument('--log_file_name', default='code_generation_eval_vicuna.log'),
