...
def parse_arguments():
    ...
    parser.add_argument('--result_old_name', default='code_summ_inference_llama2.jsonl', type=str)
    parser.add_argument('--result_save_name', default='code_summ_inference_llama2_replenish.jsonl', type=str)
    parser.add_argument('--log_file_name', default='code_summ_inference_llama2_replenish.log', type=str)
...
def main():
    mem_old_path = Path(__file__).parent.parent / Path('results') / Path(f"mem_{args.result_load_name}")
    time_old_path = Path(__file__).parent.parent / Path('results') / Path(f"time_{args.result_load_name}")
