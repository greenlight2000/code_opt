...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_summ_inference_WizardCoder.jsonl', type=str)
...
def main():
    ...
    dataset = load_dataset('json', split='train', data_files=str(load_path)).filter(lambda x:x['lang']=="GNU C")
