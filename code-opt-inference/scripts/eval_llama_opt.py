...
def add_time_optimization(example):
    ...
    user_message = f"""As an expert software developer with years of experience, please meticulously inspect the following low performance code sample and give a executable optimized version of the code, making it solve the same exact problem but achieve faster execution time or smaller memory usage.
    ...
    {{"optimization_goal": time or memory or both, “optimized_version_of_the_code”: code string}}"""
